...
export default async function ReportPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <Shell active="analysis">
      <Report d={a.diagnosis} copies={a.copies} url={a.url} isGuest={!!user.is_anonymous} site={a.site} seo={a.seo} plan={a.media_plan} summary={a.summary} competitors={a.competitors} tactics={a.tactics} gsc={a.gsc} ga4={a.ga4} />
    </Shell>
  );
}
